...
-- Decimal(154, S) and Decimal512(S) are the same maximum-precision type.
SELECT toTypeName(CAST('123.456', 'Decimal(154, 18)'));
SELECT toTypeName(CAST('123.456', 'Decimal512(18)'));

-- Decimal512 accepts scale only; precision is fixed at 154.
SELECT toTypeName(CAST('123.456', 'Decimal512(154, 18)')); -- { serverError NUMBER_OF_ARGUMENTS_DOESNT_MATCH }
