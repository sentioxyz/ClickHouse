...
String FieldVisitorDump::operator() (const DecimalField<Decimal512> & x) const { return formatQuotedWithPrefix(x, "Decimal512_"); }
...
String FieldVisitorDump::operator() (const UInt512 & x) const { return formatQuotedWithPrefix(x, "UInt512_"); }
...
String FieldVisitorDump::operator() (const Int512 & x) const { return formatQuotedWithPrefix(x, "Int512_"); }
