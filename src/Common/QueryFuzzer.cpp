...
DataTypePtr QueryFuzzer::getRandomType()
{
    ...
    static const std::vector<TypeIndex> & random_types
        = {TypeIndex::UInt8,      TypeIndex::UInt16,    TypeIndex::UInt32,      TypeIndex::UInt64,     TypeIndex::UInt128,
           ...
           TypeIndex::Float32,    TypeIndex::Float64,   TypeIndex::Date,        TypeIndex::Date32,     TypeIndex::DateTime,
           TypeIndex::DateTime64, TypeIndex::String,    TypeIndex::FixedString, TypeIndex::Enum8,      TypeIndex::Enum16,
           TypeIndex::Decimal32,  TypeIndex::Decimal64, TypeIndex::Decimal128,  TypeIndex::Decimal256, TypeIndex::Decimal512,
           TypeIndex::UUID,       TypeIndex::Array,     TypeIndex::Tuple,       TypeIndex::Nullable,   TypeIndex::LowCardinality,
           TypeIndex::Map,        TypeIndex::IPv4,      TypeIndex::IPv6,        TypeIndex::Variant,    TypeIndex::Dynamic,
           TypeIndex::Time,       TypeIndex::Time64};
    ...
    else if (type == Field::Types::Which::Float64 && fuzz_rand() % 7 == 0)
    {
        ...
        if (decimal == 0)
            ...
            child = makeASTFunction(
                "toDecimal512",
                std::make_shared<ASTLiteral>(l->value.safeGet<Float64>()),
                std::make_shared<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 154)));
    }
