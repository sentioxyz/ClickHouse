...
Like [`toUInt512`](#toUInt512), this function converts an input value to a value of type [UInt512](/reference/data-types/int-uint) but returns the default value in case of an error.
If no `default` value is passed then `0` is returned in case of an error.
    )";
    ...
    FunctionDocumentation::IntroducedIn toUInt512OrDefault_introduced_in = {26, 8};
...
Like [`toInt512`](#toInt512), this function converts an input value to a value of type [Int512](/reference/data-types/int-uint) but returns the default value in case of an error.
If no `default` value is passed then `0` is returned in case of an error.
    )";
    ...
    FunctionDocumentation::IntroducedIn toInt512OrDefault_introduced_in = {26, 8};
